                    ...
                    <div class="card-body">
                        <div class="gd-responsive-table">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <th><?php echo e(__("Refer ID")); ?></th>
                                    <td>
                                        <?php echo e($user->own_referal); ?>

                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo e(__("Refer User")); ?></th>
                                    <td>
                                        <?php if($referal): ?>
                                            <?php echo e($referal->first_name); ?> <?php echo e($referal->last_name); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($user->txn_id); ?>

                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo e(__("Txn Image")); ?></th>
                                    <td>
                                        <img src=" <?php echo e(asset($user->txn_pic)); ?> " alt="" width="60px" height="60px">
                                    </td>
                                </tr>
                                <tr>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/back/user/show.blade.php ENDPATH**/ ?>