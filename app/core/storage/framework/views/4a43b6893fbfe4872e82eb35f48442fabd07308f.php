      ...
      <div class="col-xxl-5 col-lg-6 col-md-6">
        <div class="product-gallery">
          ...
          <?php elseif($item->is_type == 'flash_deal'): ?>
            bg-success
          <?php endif; ?>
          "><?php echo e(ucfirst(str_replace('_',' ',$item->is_type))); ?></span>
                        ...
                        <div class="product-card">
                            ...
                            <?php if($related->is_stock()): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    bg-success
                                    <?php endif; ?>
                                    "><?php echo e(ucfirst(str_replace('_',' ',$related->is_type))); ?></div>
                                    <?php endif; ?>
                                    <?php else: ?>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/front/catalog/product.blade.php ENDPATH**/ ?>