...
<form class="admin-form" action="<?php echo e(route('back.items.update',$item->id)); ?>" method="POST"
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/back/item/edit.blade.php ENDPATH**/ ?>