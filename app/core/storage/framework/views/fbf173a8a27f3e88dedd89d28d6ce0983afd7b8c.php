                            ...
                            <div class="row">
                                ...
                                <div class="gd-responsive-table">
                                    ...
                                    <thead>
                                        ...
                                        <th class="px-0 bg-transparent border-top-0 text-right">
                                            <span class="h6"><?php echo e(__('Points')); ?></span>
                                        </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <?php
                                        ...
                                        $option_points += $item['attribute_points'];
                                        $total_points = $points + $option_points;
                                    ?>
                                    <tr>
                                        <td class="px-0">
                                        ...
                                        <td class="px-0 text-right">
                                            <?php echo e($item['points'] * $item['qty']); ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            <td class="px-0 border-top border-top-2">
                                                <strong><?php echo e(__('Total Points')); ?></strong>
                                            </td>
                                            <td class="px-0 text-right border-top border-top-2" colspan="5">
                                                <span class="h3">
                                                    <strong><?php echo e($total_points); ?></strong>
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/back/order/invoice.blade.php ENDPATH**/ ?>