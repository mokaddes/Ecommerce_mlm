...
<form class="admin-form" action="<?php echo e(route('alliliate.update_item',$item->id)); ?>" method="POST"
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/back/item/affiliate/edit.blade.php ENDPATH**/ ?>