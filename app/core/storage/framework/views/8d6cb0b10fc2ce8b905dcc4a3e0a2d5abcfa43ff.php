...
<div class="col-lg-4">
    <aside class="user-info-wrapper">
      <div class="user-info">
        ...
        <div class="user-data">
          <h4 class="h5"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h4><span><?php echo e(__('Joined')); ?> <?php if(isset($user->created_at)): ?><?php echo e($user->created_at->format('M D Y')); ?> <?php endif; ?></span>
        </div>
      </div>
      <nav class="list-group">
        ...
        <a class="list-group-item <?php echo e(request()->is('user/profile') ? 'active' : ''); ?>" href="<?php echo e(route('user.profile')); ?>"><i class="icon-user"></i><?php echo e(__('Profile')); ?></a>
            ...
            <a class="list-group-item <?php echo e(request()->is('user/referal_manage') ? 'active' : ''); ?>" href="<?php echo e(route('user.referal_manage')); ?>"><i class="icon-users"></i><?php echo e(__('Refer Users')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/includes/user_sitebar.blade.php ENDPATH**/ ?>