...
<body>
    <?php
        $datas = App\Models\User::with('referal')
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <?php if($datas->count() > 0): ?>
                            <li class="nav-item mr-4">
                                <a class="btn btn-sm btn-warning py-1 text-white" title="website" href="<?php echo e(route('back.user.referal')); ?>">
                                <b> Referal Request (<?php echo e($datas->count()); ?>)</b>
                                </a>
                            </li>
                        <?php endif; ?>
						<li class="nav-item mr-4">
			...
			<div class="sidebar-wrapper scrollbar-inner">
				<div class="sidebar-content">
                    ...
                    <div class="sidebar-footer text-primary d-block text-center pt-3">
                        <span class="d-inline-block"><b>Version 1.0</b></span>
                    </div>
				</div>
			</div>
		</div>
...
<?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/master/back.blade.php ENDPATH**/ ?>