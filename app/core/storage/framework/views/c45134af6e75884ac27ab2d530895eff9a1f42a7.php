          ...
          <div class="col-lg-3 order-lg-1">
            ...
            <aside class="sidebar sidebar-offcanvas position-left"><span class="sidebar-close"><i class="icon-x"></i></span>
              ...
              <section class="widget widget-categories card rounded p-4">
                ...
                <?php $__currentLoopData = $attrubute->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="custom-control custom-checkbox">
                    <input class="custom-control-input option" <?php echo e(isset($subcategory) && $subcategory->id == $options->id ? 'checked' : ''); ?>   type="checkbox" value="<?php echo e($options->name); ?>" id="<?php echo e($attrubute->id); ?><?php echo e($options->name); ?>">
                    <label class="custom-control-label" for="<?php echo e($attrubute->id); ?><?php echo e($options->name); ?>"><?php echo e($options->name); ?><span class="text-muted"></span></label>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </section>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/front/catalog/index.blade.php ENDPATH**/ ?>