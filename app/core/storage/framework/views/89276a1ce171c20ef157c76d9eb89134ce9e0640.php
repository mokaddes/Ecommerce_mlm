            ...
            <table class="table table-bordered">
              ...
              <thead>
                <tr>
                  ...
                  <th class="text-center"><?php echo e(__('Points')); ?></th>
                  <th><?php echo e(__('Product Price')); ?></th>
                  <th class="text-center"><?php echo e(__('Quantity')); ?></th>
                  <th class="text-center"><?php echo e(__('SubPoints')); ?></th>
              ...
              <tbody id="cart_view_load" data-target="<?php echo e(route('cart.get.load')); ?>">
                ...
                <tr>
                    ...
                    <td class="tp">
                        <?php echo e($ttp = $item['points'] * $item['qty']); ?>


                    </td>
                    <td class="text-center text-lg"><?php echo e(PriceHelper::setCurrencyPrice($stp = $item['main_price'] * $item['qty'])); ?></td>
                  ...
                  <?php
                        $totalPoints = $totalPoints + $ttp;
                        $totalPrice = $totalPrice + $stp;
                  ?>
  ...
  <div class="card mt-4">
      <div class="card-body">
        <div class="shopping-cart-footer">
            ...
            <div class="text-right column text-lg"><span class="text-muted"><?php echo e(__('Total Points')); ?>: </span><span class="text-gray-dark"><?php echo e($totalPoints); ?></span></div>

            <div class="text-right column text-lg"><span class="text-muted"><?php echo e(__('Subtotal')); ?>: </span><span class="text-gray-dark"><?php echo e(PriceHelper::setCurrencyPrice($totalPrice  - (Session::has('coupon') ? round(Session::get('coupon')['discount'],2) : 0))); ?></span></div>
...
<?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/includes/cart.blade.php ENDPATH**/ ?>