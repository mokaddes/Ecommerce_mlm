      ...
      <div class="padding-top-2x hidden-lg-up"></div>
        ...
        <section class="card widget widget-featured-posts widget-order-summary p-4">
            ...
            <table class="table">
              ...
              <tr>
                <td class="text-lg text-primary"><?php echo e(__('Total Points')); ?>:</td>
                <td class="text-lg text-primary "><?php echo e($points_total); ?></td>
              </tr>
            </table>
          </section>
...
<?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/includes/checkout_sitebar.blade.php ENDPATH**/ ?>