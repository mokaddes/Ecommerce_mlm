                ...
                <div class="col-md-8">
                    <div class="right-area">
                        ...
                        <div class="login-register ">
                            <?php if(!Auth::user()): ?>
                            <a class="track-order-link" href="<?php echo e(route('user.login')); ?>">
                            <?php echo e(__('Login')); ?>

                            </a>
                            <a class="track-order-link ms-3" href="<?php echo e(route('user.register')); ?>">
...
<?php /**PATH C:\xampp\htdocs\farahtech\app\core\resources\views/master/front.blade.php ENDPATH**/ ?>