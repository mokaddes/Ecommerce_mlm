...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Manage Products'], function () {
            ...
            Route::post('item/update/{id}', 'Back\ItemController@update')->name('back.items.update');
            ...
            Route::post('affiliate/update/{id}', 'Back\AffiliateController@update')->name('alliliate.update_item');
            // ----------- AFFILIATE PRODUCT -----------//
        ...
        Route::group(['middleware' => 'permissions:Customer List'], function () {
            ...
            // user_referal_manage
            Route::get('user/send-referal/{id}', 'Back\UserController@send_referal')->name('back.user.send_referal');
            Route::get('show-referal', 'Back\UserController@referal')->name('back.user.referal');
            Route::post('referal_submit', 'Back\UserController@referal_submit')->name('back.user.referal_submit');
            Route::get('user/active/{id}', 'Back\UserController@active')->name('back.user.active');
            Route::get('user/inactive/{id}', 'Back\UserController@inactive')->name('back.user.inactive');
            Route::get('user/refer/{user}', 'Back\UserController@refer')->name('back.user.refer');
        });
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::get('/register/choose/product', 'Auth\User\RegisterController@showProduct')->name('user.choose.product');
            Route::get('/register/referal', 'Auth\User\RegisterController@showReferer')->name('user.referal');
            Route::get('/register/shpping/address', 'Auth\User\RegisterController@ShippintAddress')->name('user.shipping.address');
            Route::post('/register/shpping_submit', 'Auth\User\RegisterController@shippingStore')->name('user.shipping_submit');
            Route::post('/register/referal/mail', 'Auth\User\RegisterController@referal_mail')->name('user.referal.mail');
            Route::post('/register/referal-submit', 'Auth\User\RegisterController@referal')->name('user.referal.submit');
            Route::post('/register/signup_product', 'Auth\User\RegisterController@signup_product')->name('user.product.submit');
            Route::get('/register/payment', 'Auth\User\RegisterController@showPayment')->name('user.payment');
            Route::post('/register/payment', 'Auth\User\RegisterController@user_payment')->name('user.payment.submit');
            ...
            // Referal Manage
            Route::get('/referal_manage', 'User\AccountController@referal_manage')->name('user.referal_manage');
