        ...
        <div class="u-table-res">
          <table class="table table-bordered mb-0">
            <thead>
                <tr>
                    <th colspan="6">
                        <strong>Order for : {{ $user->first_name .' '. $user->last_name }}</strong>
                        @if($user->id != Auth::id())
                        <a href="{{ route('user.order.index') }}" style="float: right">Go to my Orders</a>
                        @endif
                    </th>
                </tr>
              <tr>
            ...
            <tbody>
             ...
             <tr>
              ...
              {{-- <td>{{ $order->state_price }}</td> --}}
              <td>
                {{PriceHelper::OrderPoints($order)}}
              </td>
              <td>
