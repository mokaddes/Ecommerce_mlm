                                        ...
                                        <div class="">
                                            ...
                                            <div id="basic" class="tab-pane active"><br>
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="first_ref_bonus">{{ __('First ref. bonus') }} *</label>
                                                            <input type="number" name="first_ref_bonus" id="first_ref_bonus" class="form-control" value="{{ $setting->first_ref_bonus }}">
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="second_ref_bonus">{{ __('Second ref. bonus') }} *</label>
                                                            <input type="number" name="second_ref_bonus" id="second_ref_bonus" class="form-control" value="{{ $setting->second_ref_bonus }}">
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="regi_fee_rm">{{ __('Registration fee RM') }} *</label>
                                                            <input type="number" name="regi_fee_rm" id="regi_fee_rm" class="form-control" value="{{ $setting->regi_fee_rm }}" >
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="regi_fee_sgd">{{ __('Registration fee SGD') }} *</label>
                                                            <input type="number" name="regi_fee_sgd" id="regi_fee_sgd" class="form-control" value="{{ $setting->regi_fee_sgd }}">
                                                        </div>
                                                    </div>
