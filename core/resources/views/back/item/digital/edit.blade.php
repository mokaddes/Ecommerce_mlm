        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="signup_choose">{{ __('signup Choose') }} </label>
                        <br>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="defaultInline1" name="signup_choose" value="1" {{$item->signup_choose == 1? 'checked': ''}} >
                            <label class="custom-control-label" for="defaultInline1">Yes</label>
                        </div>

                          <!-- Default inline 2-->
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="defaultInline2" name="signup_choose" value="0" {{$item->signup_choose == 0? 'checked': ''}}>
                            <label class="custom-control-label" for="defaultInline2">No</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="is_type">{{ __('Product Type') }} *</label>
                        <select name="is_type" id="" class="form-control">
                            <option value="">Choose One</option>
                            <option value="new" {{ $item->is_type == 'new' ? 'selected': '' }} >New</option>
                            <option value="top" {{ $item->is_type == 'top' ? 'selected': '' }}>Top</option>
                            <option value="feature" {{ $item->is_type == 'feature' ? 'selected': '' }}>Feature</option>
                            <option value="best" {{ $item->is_type == 'best' ? 'selected': '' }}>Best</option>
                            <option value="flash_deal" {{ $item->is_type == 'flash_deal' ? 'selected': '' }}>Flash Deal</option>
                        </select>
                    </div>
                </div>
            </div>
