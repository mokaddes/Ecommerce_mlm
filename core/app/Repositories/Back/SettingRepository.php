...
class SettingRepository
{
    ...
    public function update($request)
    {
        ...
        $input['first_ref_bonus']   =  $request->first_ref_bonus;
        $input['second_ref_bonus']  =  $request->second_ref_bonus;
        $input['regi_fee_rm']       =  $request->regi_fee_rm;
        $input['regi_fee_sgd']      =  $request->regi_fee_sgd;
